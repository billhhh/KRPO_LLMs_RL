...
def get_arguments():
    ...
    parser.add_argument("--load_name", type=str, default='debug')
    return parser
...
def main():
    ...
    # dataset related
    dataset_path = "data/MathTasks/MathTasks_test.jsonl"
    ...
    reference_model, _ = load_model(model_name, model_name, device_map=device)  # Llama model
    model, tokenizer = load_model(model_name, checkpoint_path, device_map=device)
    ...
    for epoch in range(num_epochs):
        for k, prompt_batch in enumerate(prompt_loader):
            ...
            with torch.no_grad():
                for q, a in zip(questions, answers):
                    ...
                    if model_think is not None:
                        ...
                        print('model_think:', model_think.string)
            ...
            final_return.append(episode_return_sum)
    ...
    average_return = sum(final_return) / len(final_return)
    print('Final average_return:', average_return)
